...
//      System.out.println("KeyTyped: " + e);
  ...
  public void keyPressed(KeyEvent e) {
    if (Options.ECHO_KEYBOARD) {
      ...
      if(e.getKeyCode() == 0x27) {
    	  this.m_model.m_hero.move('E', m_model.m_plateformes);
      }
      else if(e.getKeyCode() == 0x25) {
    	  this.m_model.m_hero.move('W', m_model.m_plateformes);
      }
      else if(e.getKeyCode() == 0x26) {
    	  this.m_model.m_hero.move('N', m_model.m_plateformes);
      }
      else if(e.getKeyCode() == 0x28) {
    	  this.m_model.m_hero.move('S', m_model.m_plateformes);
      }
      else if(e.getKeyCode() == 0x4D) {
    	  for(int i = 0; i < 1; i++) {
    		  this.m_model.m_missiles.add(new Missile(this.m_model, this.m_model.m_hero));
    	  }
      }
    }
  }
  ...
  public void notifyVisible() {
    ...
    m_Mario_HP = new Label("Mario HP : "+m_model.m_hero.getHP()+"");
    if(m_model.m_hero.getHP() < 2) {
    	m_Mario_HP.setForeground(Color.red);
    }
    cont.add(m_Mario_HP);
